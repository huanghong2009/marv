...
public class OtpAuthUtils {
     ...
     * @return
     */
    public static boolean checkTotpCode(String code,String secretKey,int timeStepSeconds) throws Exception {
        String number = null;
        try {
            number = generateNumberString(secretKey, System.currentTimeMillis(), timeStepSeconds);
        } catch (GeneralSecurityException e) {
            e.printStackTrace();
            throw new Exception("获取秘钥码出错");
        }
        return code.equals(number);
    }
     ...
     * @return
     */
    public static boolean checkTotpCode(String code,String secretKey) throws Exception {
        return checkTotpCode(code,secretKey,30);
    }
     ...
     * @return
     */
    public static String getTotpCode(String secretKey) throws Exception {
        return getTotpCode(secretKey,30);
    }
     ...
     * @return
     */
    public static String getTotpCode(String secretKey,int timeStepSeconds) throws Exception {
        String number = null;
        try {
            number = generateNumberString(secretKey, System.currentTimeMillis(), timeStepSeconds);
        } catch (GeneralSecurityException e) {
     ...
     */
    private static boolean validateCurrentNumber(String base32Secret, int authNumber, int windowMillis)
     ...
     */
    private static long generateCurrentNumber(String base32Secret) throws GeneralSecurityException {
     ...
     */
    private static String qrImageUrl(String keyId, String secret) {
     ...
     *            Secret string that will be used when generating the current number.
     */
    private static String generateOtpAuthUrl(String keyId, String secret) {
