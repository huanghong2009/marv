...
public class DFATools {
     ...
     * 构造函数，初始化敏感词库
     */
    public DFATools(Set<String> wordSet) {
        sensitiveWordMap = new DFAInit().initKeyWord(wordSet);
    }
    ...
    public static Set<String> ListToSet(List<String> wordList){
        ...
        for (int i = beginIndex; i < txt.length(); i++) {
            ...
            if (nowMap != null) {
                ...
                if ("1".equals(nowMap.get("isEnd"))) {
                    ...
                    if (DFATools.minMatchTYpe == matchType) {
                        break;
                    }
                }
            }
