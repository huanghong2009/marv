...
public final class MD5 {
    ...
    public static String getstrs(String str, String salt) {
        MD5 m = new MD5();
        ...
        sb.append("]");
        sb.reverse();
        return m.getMD5ofStr(sb.toString());
    }

    public static String selfMD5(String str) {
        String des = getstrs(str);
        StringBuffer change = new StringBuffer(des.length());
        int[] pos = new int[]{31, 30, 23, 21, 22, 20, 29, 25, 28, 27, 24, 26, 3, 1, 2, 0, 9, 5, 8, 7, 4, 6, 13, 11, 12, 10, 19, 15, 18, 17, 14, 16};
    ...
    public static void main(String[] args) {
        ...
        System.out.println(getstrs(str, "HNCK2000"));
    }
}
